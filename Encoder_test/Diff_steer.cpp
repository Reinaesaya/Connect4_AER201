...
DiffSteering::DiffSteering(int EN, int LM_F, int LM_B, int RM_F, int RM_B) :
  enable_pin (EN), left_motor_f (LM_F), left_motor_b (LM_B), right_motor_f (RM_F), right_motor_b (RM_B)
{
